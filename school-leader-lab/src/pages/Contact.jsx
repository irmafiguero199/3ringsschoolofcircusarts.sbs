...
function Contact() {
  ...
  return (
    <>
      <Helmet>
        <title>Contact — 3 Rings School Of Circus Arts</title>
        <meta name="description" content="Contactez 3 Rings School Of Circus Arts. Adresse : 3256 39th Ave Sw, Seattle, WA 98116-3414. Email : admin@3ringsschoolofcircusarts.sbs. Téléphone : (206) 555-1234. EIN 47-4079081." />
      </Helmet>
      <div className="bg-primary-900 text-white py-16">
        <div className="container-main px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Contactez-nous</h1>
          <p className="text-primary-100 text-lg max-w-2xl mx-auto">Notre équipe est à votre disposition pour toute question sur nos programmes d'arts du cirque, nos admissions ou nos partenariats.</p>
        </div>
      </div>
            ...
            <div className="lg:col-span-1 space-y-8">
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div><p className="font-semibold text-slate-900">Adresse postale</p><p className="text-sm text-slate-600">3256 39th Ave Sw<br />Seattle, WA 98116-3414<br />United States</p></div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div><p className="font-semibold text-slate-900">Téléphone</p><a href="tel:+12065551234" className="text-sm text-primary-700 hover:underline">(206) 555-1234</a></div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div><p className="font-semibold text-slate-900">Email</p><a href="mailto:admin@3ringsschoolofcircusarts.sbs" className="text-sm text-primary-700 hover:underline">admin@3ringsschoolofcircusarts.sbs</a></div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div><p className="font-semibold text-slate-900">Horaires du secrétariat</p><p className="text-sm text-slate-600">Lundi — Vendredi : 9h00 — 17h00 (PST)<br />Samedi — Dimanche : Fermé</p></div>
                  </div>
                </div>
              </div>
              <div className="bg-slate-50 p-6 rounded-xl border border-slate-200">
                ...
                <ul className="space-y-2 text-sm text-slate-600">
                  <li><strong>Nom légal :</strong> 3 Rings School Of Circus Arts</li>
                  <li><strong>EIN fédéral :</strong> 47-4079081</li>
                  <li><strong>Statut :</strong> Organisation 501(c)(3)</li>
                  <li><strong>Adresse :</strong> 3256 39th Ave Sw, Seattle, WA 98116-3414</li>
                  <li><strong>Domaine :</strong> 3ringsschoolofcircusarts.sbs</li>
                </ul>
              </div>
            </div>
            <div className="lg:col-span-2">
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="bg-white p-8 rounded-xl border border-slate-200 space-y-6">
                  ...
                  <p className="text-xs text-slate-500">3 Rings School Of Circus Arts — EIN 47-4079081 — 3256 39th Ave Sw, Seattle, WA 98116-3414. Conforme aux réglementations en vigueur.</p>
                </form>
              )}
            </div>
          </div>
