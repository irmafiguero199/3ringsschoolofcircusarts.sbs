    ...
    <header className="sticky top-0 z-50 bg-white shadow-sm">
      <div className="bg-primary-900 text-white text-xs py-2">
        <div className="container-main px-4 flex flex-wrap items-center justify-between gap-2">
          <div className="flex items-center gap-4 flex-wrap">
            <span className="flex items-center gap-1"><Shield className="w-3 h-3" />EIN: 47-4079081</span>
            <span className="flex items-center gap-1"><MapPin className="w-3 h-3" />3256 39th Ave Sw, Seattle, WA 98116-3414</span>
          </div>
          <div className="flex items-center gap-4">
            <a href="mailto:admin@3ringsschoolofcircusarts.sbs" className="flex items-center gap-1 hover:text-primary-200 transition-colors"><Mail className="w-3 h-3" />admin@3ringsschoolofcircusarts.sbs</a>
            <a href="tel:+12065551234" className="flex items-center gap-1 hover:text-primary-200 transition-colors"><Phone className="w-3 h-3" />(206) 555-1234</a>
          </div>
        </div>
      </div>
      <div className="container-main px-4 py-4 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2 text-xl font-bold text-primary-900">
          <GraduationCap className="w-8 h-8" />3 RINGS SCHOOL OF CIRCUS ARTS
        </Link>
